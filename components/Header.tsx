  ...
  return (
    <header className="w-full p-4 relative">
      ...
      <nav className="container mx-auto flex items-center justify-start relative z-10">
        <div className="flex space-x-4 text-m text-[#011627]">
          <Link href="/" className="hover:text-[#b6244f] font-bold transition-colors duration-300">
            Home
          </Link>
          <Link href="/about" className="hover:text-[#b6244f] font-bold transition-colors duration-300">
            About
          </Link>
